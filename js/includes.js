...
<nav id="navbar" class="fixed w-full z-50 transition-all duration-500 bg-white border-b border-black/5" aria-label="Main navigation">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between items-center h-16 lg:h-24">
            ...
            <div class="hidden lg:flex items-center space-x-10">
                <a href="index.html" data-nav="home" class="nav-link text-[#111111] font-josefin text-base uppercase hover:text-primary transition-colors">Home</a>
                <a href="about.html" data-nav="about" class="nav-link text-[#111111] font-josefin text-base uppercase hover:text-primary transition-colors">About</a>
                <a href="buy.html" data-nav="buy" class="nav-link text-[#111111] font-josefin text-base uppercase hover:text-primary transition-colors">Buy</a>
                <a href="sell.html" data-nav="sell" class="nav-link text-[#111111] font-josefin text-base uppercase hover:text-primary transition-colors">Sell</a>
                <a href="blog.html" data-nav="blog" class="nav-link text-[#111111] font-josefin text-base uppercase hover:text-primary transition-colors">Blog</a>
                <a href="contact.html" data-nav="contact" class="nav-link text-[#111111] font-josefin text-base uppercase hover:text-primary transition-colors">Contact</a>
            ...
            <button id="mobile-menu-btn" class="lg:hidden text-[#111111] hover:text-primary transition-colors" aria-label="Open menu" type="button">
                ${ICON_MENU}
            </button>
        </div>
    </div>
    ...
    <div id="mobile-menu" class="mobile-menu fixed top-0 right-0 w-80 h-full bg-white z-50 lg:hidden">
        <div class="p-6">
            <button id="close-menu-btn" class="absolute top-6 right-6 text-[#111111] hover:text-primary" aria-label="Close menu" type="button">
                ${ICON_CLOSE}
            </button>
            <div class="mt-16 space-y-6">
                <a href="index.html" data-nav="home" class="block text-[#111111] font-josefin text-lg hover:text-primary transition-colors">Home</a>
                <a href="about.html" data-nav="about" class="block text-[#111111] font-josefin text-lg hover:text-primary transition-colors">About</a>
                <a href="buy.html" data-nav="buy" class="block text-[#111111] font-josefin text-lg hover:text-primary transition-colors">Buy</a>
                <a href="sell.html" data-nav="sell" class="block text-[#111111] font-josefin text-lg hover:text-primary transition-colors">Sell</a>
                <a href="blog.html" data-nav="blog" class="block text-[#111111] font-josefin text-lg hover:text-primary transition-colors">Blog</a>
                <a href="contact.html" data-nav="contact" class="block text-[#111111] font-josefin text-lg hover:text-primary transition-colors">Contact</a>
...
const FOOTER_HTML = `
<div class="bg-white text-[#111111] pt-16 border-t border-black/10">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="grid md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
            <div>
                ...
                <p class="text-[#5D5D5D] font-poppins text-sm leading-relaxed mb-6">
            ...
            <div>
                ...
                <ul class="space-y-3">
                    <li><a href="index.html" class="text-[#5D5D5D] hover:text-primary transition-colors font-poppins text-sm">Home</a></li>
                    <li><a href="about.html" class="text-[#5D5D5D] hover:text-primary transition-colors font-poppins text-sm">About</a></li>
                    <li><a href="buy.html" class="text-[#5D5D5D] hover:text-primary transition-colors font-poppins text-sm">Buy a Home</a></li>
                    <li><a href="sell.html" class="text-[#5D5D5D] hover:text-primary transition-colors font-poppins text-sm">Sell Your Home</a></li>
                    <li><a href="contact.html" class="text-[#5D5D5D] hover:text-primary transition-colors font-poppins text-sm">Contact</a></li>
                </ul>
            </div>
            ...
            <div>
                ...
                <ul class="space-y-3">
                    <li><a href="buy.html" class="text-[#5D5D5D] hover:text-primary transition-colors font-poppins text-sm">Buyer Representation</a></li>
                    <li><a href="sell.html" class="text-[#5D5D5D] hover:text-primary transition-colors font-poppins text-sm">Seller Representation</a></li>
                    <li><a href="https://www.raveis.com/contact/homevaluationwizard?SITE=agt&AGT=9216&" target="_blank" class="text-[#5D5D5D] hover:text-primary transition-colors font-poppins text-sm">Home Valuation</a></li>
                </ul>
            </div>
            ...
            <div>
                ...
                <ul class="space-y-3">
                    <li class="text-[#5D5D5D] font-poppins text-sm">914.980.2402</li>
                    <li class="text-[#5D5D5D] font-poppins text-sm">Connie.Stetler@Raveis.com</li>
                    <li class="text-[#5D5D5D] font-poppins text-sm">78 Purchase St</li>
                    <li class="text-[#5D5D5D] font-poppins text-sm">Rye, NY 10580</li>
                    <li class="text-[#5D5D5D] font-poppins text-sm">Lic. #10301219833</li>
                </ul>
            </div>
        </div>

        <div class="border-t border-black/10 pt-8 flex flex-col md:flex-row items-center justify-between space-y-4 md:space-y-0">
            <p class="text-[#5D5D5D]/80 font-poppins text-sm">
...
function applyActiveNav(page) {
    ...
    navLinks.forEach((link) => {
        link.classList.remove('text-[#111111]', 'hover:text-primary');
